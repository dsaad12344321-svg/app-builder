...
public class LeanWebView extends WebView implements GoNativeWebviewInterface, NestedScrollingChild {
    ...
    private boolean isHideNavOnScrollEnabled = false;
    private int mLastY;
    ...
    private void initScrollBehavior(Context context) {
        AppConfig appConfig = AppConfig.getInstance(context);
        this.isHideNavOnScrollEnabled = appConfig.hideTopNavBarOnScroll || appConfig.hideBottomNavBarOnScroll;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (!isHideNavOnScrollEnabled || disableAutoHide || ev.getPointerCount() > 1)
