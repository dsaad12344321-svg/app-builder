...
median.webview = {
    ...
    setZoom: function(scale){
        return addCommandCallback("median://webview/setZoom", { scale });
    },
    getZoom: function(params){
        return addCommandCallback("median://webview/getZoom", params);
    }
};
...
median.systemBars = {
    set: function (params){
        addCommand("median://systemBars/set", params);
    }
};
...
median.system = {
    exitApp: function() {
        addCommand("median://system/exitApp");
    }
}
