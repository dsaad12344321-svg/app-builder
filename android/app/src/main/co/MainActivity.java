...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        getGNApplication().mBridge.onRestoreInstanceState(this, savedInstanceState);
    }
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        getGNApplication().mBridge.onSaveInstanceState(this, outState);
    ...
    private void checkReadyStatusResult(String status) {
        ...
        if (status.equals("complete") || status.equals("interactive")) {
            contentReady();
            setAbsoluteZoom(AppConfig.getInstance(this).initialZoom, null);
        }
    }
    ...
    @Override
    public void setAbsoluteZoom(float targetScale, String callback) {
        try {
            if (targetScale <= 0f) {
                if (!TextUtils.isEmpty(callback)) {
                    ...
                    runJavascript(LeanUtils.createJsForCallback(callback, response));
                }
                return;
            }
            ...
            AppConfig appConfig = AppConfig.getInstance(this);
            appConfig.initialZoom = targetScale;
            appConfig.saveWebviewZoom(targetScale);
            ...
            try {
                ...
                runJavascript(LeanUtils.createJsForCallback(callback, result));
